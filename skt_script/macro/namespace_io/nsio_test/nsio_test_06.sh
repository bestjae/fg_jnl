...
if [ $argc -lt 2 ]; then
    echo "Usage : ./nsio_test_06.sh [device name] [test_count]"
...
echo "<Test scenario : (/dev/nvme0n1~nvme0n3 : flush), (/dev/nvme0n4~nvme0n6 : format), (/dev/nvme0n7~nvme0n8: read/write>"
