...
if [ $argc -lt 2 ]; then
    echo "Usage : ./nsio_test_03.sh [device name] [test_count]"
...
do
    ...
    echo "error_log -> /dev/nvme0n1,2,3,4"
    ${script_dir}/../../../micro/error_log.sh $dev_name 64 1 
    ${script_dir}/../../../micro/error_log.sh $dev_name 64 2
    ${script_dir}/../../../micro/error_log.sh $dev_name 64 3
    ${script_dir}/../../../micro/error_log.sh $dev_name 64 4
    printf "/dev/nvme0n5 -> "
