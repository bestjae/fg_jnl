...
if [ $argc -lt 2 ]; then
    echo "Usage : ./nsio_test_08.sh [device name] [test_count]"
...
echo "<Test scenario : (/dev/nvme0n1 : get_log), (/dev/nvme0n2 : smart_log)"
echo "                 ,(/dev/nvme0n3 : error_log), (/dev/nvme0n4 : flush)"
echo "                 ,(/dev/nvme0n5 : format), (dev/nvme0n6~nvme0n8 : read/write)>"
