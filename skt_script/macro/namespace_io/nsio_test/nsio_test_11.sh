...
if [ $argc -lt 2 ]; then
    echo "Usage : ./nsio_test_11.sh [device name] [test_count]"
...
${script_dir}/../../check_list/power_cycle.sh > /dev/null 2> /dev/null

echo "<Test scenario : (/dev/nvme0 : reset),(/dev/nvme0n1~nvme0n8 : format)"
for (( i=1;i<=$test_count;i++ ))
do
    echo "Test scenario progress :" $i"/"$test_count 
#${script_dir}/../../../micro/reset.sh $dev_name 
    ${script_dir}/../../../micro/format.sh $dev_name 1 
    ${script_dir}/../../../micro/format.sh $dev_name 2 
    ${script_dir}/../../../micro/format.sh $dev_name 3 
    ${script_dir}/../../../micro/format.sh $dev_name 4 
    ${script_dir}/../../../micro/format.sh $dev_name 5 
    ${script_dir}/../../../micro/format.sh $dev_name 6 
    ${script_dir}/../../../micro/format.sh $dev_name 7 
    ${script_dir}/../../../micro/format.sh $dev_name 8 
done
echo -e "\n"
