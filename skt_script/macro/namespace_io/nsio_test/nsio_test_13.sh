...
echo $total_support_ns
if [ $argc -lt 2 ]; then
    echo "Usage : ./nsio_test_13.sh [device name] [test_count]"
...
echo "<Test scenario : namespace I/O verify test>"
...
do
    ...
    do
		...
		echo "${dev_name}n${k} I/O verify success"
        echo -e "\n"
    done
	echo -e "\n"
done
