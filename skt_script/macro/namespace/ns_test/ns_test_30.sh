...
if [ $argc -lt 2 ]; then
    echo "Usage : ./ns_test_30.sh [device] [test_count]"
...
echo "<Test scenario : Namespace create -> list-ns -> subsystem reset -> power cycle -> list-ns -> namespace verify>"
...
do
    ...
    ${script_dir}/../../../micro/subsystem-reset.sh $dev_name 
